    ...
    return (
        <div className="w-full h-full flex justify-center items-center my-4 mt-10">
            <div className="max-w-7xl w-full h-full px-4 py-2">
                <div className=" w-full h-1/2 items-center  flex  mb-2">
                    <div className="flex h-full items-center  ">
                        <p className="text-xs font-light text-[#82603f]">More way to follow</p>
                ...
                <div className="flex justify-between w-full h-1/2 items-center border-[#82603f] border-t pt-2 text-[#82603f]">
                    ...
                    <Link href={"/cookiepolicy"}>
                        <p className="text-xs font-light underline cursor-pointer">Privacy Policy</p>
                    </Link>
